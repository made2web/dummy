<template>
  <div class="container">
    ...
    <p>Se o cancro for diagnosticado em fases avançadas, ou seja, já não estiver localizado apenas na próstata, os tratamentos são mais agressivos. Nestes casos, têm um intuito paliativo. Procura-se controlar a doença, impedir a sua progressão e minimizar os sintomas.</p>
    <p>Por isso, e como regra, quanto mais precocemente se diagnosticar um cancro da próstata, maior será a eficácia do tratamento, menores serão as consequências do tumor e dos seus tratamentos, menores as taxas de complicações e os efeitos secundários.</p>
  </div>
</template>